...
public class Main {
	...
	public static final String CONTACTS_SHARE_NUMB = "There are contacts that share phone numbers.";
	public static final String CONTACTS_DIFERENT_NUMB = "All contacts have different phone numbers.";
	...
	private static void samePhone(ContactBook cBook) {
		if (cBook.hasSamePhone())
			System.out.println(CONTACTS_SHARE_NUMB);
		else
			System.out.println(CONTACTS_DIFERENT_NUMB);
	}
}
